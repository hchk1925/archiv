...
### Onboarding pro agenta · Duben 2026 · Verze 3.2

> **Pracovní jazyk:** česky (odpovědi, komentáře k datům).  
> **Kód / identifikátory:** anglicky (sloupce, klíče, Python).

> **Update v3.2 (04/2026):** Přidána pravidla D37–D41 z práce na 53/54 a 54/55. Audit duplicit napříč 6 sezónami (29 sloučení). Dokončen audit sezón 53/54 (98%) a 54/55 (97%).
...
| **D35** | **53/54: ponecháváme almanachové názvy klubů** (ne striktní sjednocení A+B dle D21). Almanach 53/54 má TJ prefix selektivně u některých klubů (např. „TJ Spartak Motorlet" vs „Spartak Tatra Smíchov B" bez TJ) — to je autentický záznam a zachováváme. D21 striktní pravidlo je pozastaveno pro 53/54+. |
